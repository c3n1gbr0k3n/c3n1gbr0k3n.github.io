...
`}),e.add({id:4,href:"/docs/exploit/stackoverflow/ret2libc/",title:"ret2libc",description:`0x01 介绍 # 我们一般gcc编译不加 -static 的话默认就是动态链接，动态链接就是不将代码嵌入到你的程序中，而是等程序运行时再链接到动态链接库，从而减小程序的大小。我们可以对比以下动态和静态的区别
...
具体的可以自己多调试看看
`}),e.add({id:5,href:"/docs/exploit/",title:"Exploit",description:"",content:""}),e.add({id:6,href:"/docs/exploit/formatstring/%E6%A0%BC%E5%BC%8F%E5%8C%96%E5%AD%97%E7%AC%A6%E4%B8%B2%E6%BC%8F%E6%B4%9E/",title:"格式化字符串漏洞",description:`0x01 介绍 # 在学习C语言的时候，一般第一个学习的函数就是printf函数。它最常用的用法是通过格式化字符串来格式化输出内容，例如
...
`}),e.add({id:7,href:"/docs/exploit/stackoverflow/",title:"StackOverflow",description:"",content:""}),e.add({id:8,href:"/docs/",title:"Docs",description:"learn docs",content:""}),search.addEventListener("input",t,!0);function t(){const s=5;var n=this.value,o=e.search(n,{limit:s,enrich:!0});const t=new Map;for(const e of o.flatMap(e=>e.result)){if(t.has(e.doc.href))continue;t.set(e.doc.href,e.doc)}if(suggestions.innerHTML="",suggestions.classList.remove("d-none"),t.size===0&&n){const e=document.createElement("div");e.innerHTML=`No results for "<strong>${n}</strong>"`,e.classList.add("suggestion__no-results"),suggestions.appendChild(e);return}for(const[r,a]of t){const n=document.createElement("div");suggestions.appendChild(n);const e=document.createElement("a");e.href=r,n.appendChild(e);const o=document.createElement("span");o.textContent=a.title,o.classList.add("suggestion__title"),e.appendChild(o);const i=document.createElement("span");if(i.textContent=a.description,i.classList.add("suggestion__description"),e.appendChild(i),suggestions.appendChild(n),suggestions.childElementCount==s)break}}})()