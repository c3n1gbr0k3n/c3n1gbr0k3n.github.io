...
具体的可以自己多调试看看
`}),e.add({id:5,href:"/docs/exploit/stackoverflow/stack_pivoting/",title:"栈迁移",description:`0x01 介绍 # 很多时候由于溢出栈字节不够多，不能构造完整的payload，这时候就需要用到stack pivoting技巧来完成操作。它的核心理念在于如果我们在某个内存中可以输入完整的payload，那么我们就可以用该技巧将当前栈顶指针修改指向这段内存，然后通过一些指令来执行这段内存里的payload。
...
`}),e.add({id:6,href:"/docs/exploit/stackoverflow/canary_blast/",title:"Canary爆破",description:`0x01 介绍 # Canary能够爆破的情况非常少，必要条件有两点：
