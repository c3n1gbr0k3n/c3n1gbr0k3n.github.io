...
具体的可以自己多调试看看
`}),e.add({id:5,href:"/docs/exploit/formatstring/",title:"FormatString",description:"",content:""}),e.add({id:6,href:"/docs/exploit/formatstring/%E6%A0%BC%E5%BC%8F%E5%8C%96%E5%AD%97%E7%AC%A6%E4%B8%B2%E6%BC%8F%E6%B4%9E/",title:"格式化字符串漏洞",description:`0x01 介绍 # 在学习C语言的时候，一般第一个学习的函数就是printf函数。它最常用的用法是通过格式化字符串来格式化输出内容，例如
